...
const GroupComponent: NextPage = () => {
  return (
    <div className=" self-strecth flex-1 flex flex-row items-start justify-start py-[18px] px-0 box-border relative min-w-[126px] whitespace-nowrap text-center text-xl text-black font-roboto">
